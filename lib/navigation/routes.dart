...
class EmotionStationRoutes {
  ...
  static const NavigationItem completedActivityDetails = NavigationItem(
      routeName: 'completedActivityDetails',
      path: 'completed_activity_details');
  static const NavigationItem childDetailsScreen = NavigationItem(
      routeName: 'childDetailsScreen', path: 'child_details_screen');
