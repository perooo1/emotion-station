  ...
  QuestionsEnglish() {
    questionsHappiness = [
      ...
      Question(
        ...
        options: [
          ...
          Option(
              ...
              comprehensionLevel: ComprehensionLevel.high),
          Option(text: 'The swans noticed him hiding.', comprehensionLevel: ComprehensionLevel.low),
        ],
      ),
      Question(
       ...
       I was speechless, I didn't expect that! It was a wonderful, unexpected surprise!!''',
        ...
        options: [
          ...
          Option(
              ...
              comprehensionLevel: ComprehensionLevel.low),
          Option(
              text: 'He was surprised because he didn\'t expect a birthday surprise.',
              comprehensionLevel: ComprehensionLevel.high),
        ],
      ),
      Question(
        ...
        opservationCategory: OpservationCategory.emotionUnderstandingVisual,
        options: [
          Option(text: 'Surprised', comprehensionLevel: ComprehensionLevel.partial),
      ...
      Question(
        ...
        opservationCategory: OpservationCategory.emotionUnderstandingVisual,
        options: [
          Option(text: 'Surprise.', comprehensionLevel: ComprehensionLevel.high),
          Option(text: 'Happiness.', comprehensionLevel: ComprehensionLevel.partial),
          Option(text: 'Confusion.', comprehensionLevel: ComprehensionLevel.low),
        ],
      ),
    ];
    ...
    questionsSadness = [
      ...
      Question(
        ...
        opservationCategory: OpservationCategory.emotionReckognition,
        options: [
          Option(text: 'The picture shows happiness', comprehensionLevel: ComprehensionLevel.low),
          Option(text: 'The picture shows sadness', comprehensionLevel: ComprehensionLevel.partial),
          Option(
      ...
      Question(
        ...
        options: [
          Option(
              ...
              comprehensionLevel: ComprehensionLevel.high),
          Option(
              text: 'Sad because of her friends.', comprehensionLevel: ComprehensionLevel.partial),
          Option(
      ...
      Question(
        ...
        options: [
          Option(
              text: 'In this picture anger preveils.', comprehensionLevel: ComprehensionLevel.low),
          Option(
      ...
      Question(
        ...
        opservationCategory: OpservationCategory.emotionUnderstandingVisual,
        options: [
          Option(text: 'Disappointment', comprehensionLevel: ComprehensionLevel.high),
          Option(text: 'Sadness', comprehensionLevel: ComprehensionLevel.partial),
          Option(text: 'Fear', comprehensionLevel: ComprehensionLevel.low),
        ],
      ),
    ];
    ...
    questionsAnger = [
      Question(
        ...
        options: [
          ...
          Option(text: 'Disappointment', comprehensionLevel: ComprehensionLevel.low),
        ],
      ),
      Question(
        imageAssetPath: shuffledImages.getRandomJelousBasic(),
        ...
        opservationCategory: OpservationCategory.emotionReckognition,
        options: [
          Option(text: 'Anger is shown.', comprehensionLevel: ComprehensionLevel.partial),
          Option(text: 'Sadness is shown.', comprehensionLevel: ComprehensionLevel.low),
          Option(text: 'Jealousy is shown', comprehensionLevel: ComprehensionLevel.high),
        ],
      ),
      Question(
      ...
      Question(
        ...
        options: [
          Option(
              ...
              comprehensionLevel: ComprehensionLevel.high),
          Option(
              text: 'She was angry because no one was paying attention to her drawing.',
              comprehensionLevel: ComprehensionLevel.partial),
          Option(
              text: 'She was happy for other kitten.', comprehensionLevel: ComprehensionLevel.low),
        ],
      ),
      Question(
        imageAssetPath: shuffledImages.getRandomAngerRecognitionsComplex(),
        ...
        opservationCategory: OpservationCategory.emotionUnderstandingVisual,
        options: [
          Option(text: 'I think this is fear.', comprehensionLevel: ComprehensionLevel.low),
          Option(text: 'I think this is happiness.', comprehensionLevel: ComprehensionLevel.low),
          Option(text: 'I think this is anger.', comprehensionLevel: ComprehensionLevel.high),
        ],
      ),
      Question(
        imageAssetPath: shuffledImages.getRandomJelousComplex(),
    ...
    questionsFear = [
      Question(
        ...
        opservationCategory: OpservationCategory.emotionReckognition,
        options: [
          Option(text: 'I see happiness.', comprehensionLevel: ComprehensionLevel.low),
          Option(text: 'I see fear.', comprehensionLevel: ComprehensionLevel.high),
          Option(text: 'I see anger.', comprehensionLevel: ComprehensionLevel.low),
        ],
      ),
      Question(
        imageAssetPath: shuffledImages.getRandomNervousBasic(),
        ...
        opservationCategory: OpservationCategory.emotionReckognition,
        options: [
          Option(text: 'Picture shows fear.', comprehensionLevel: ComprehensionLevel.partial),
          Option(text: 'Picture shows sadness.', comprehensionLevel: ComprehensionLevel.low),
          Option(text: 'Picture shows nervousness.', comprehensionLevel: ComprehensionLevel.high),
        ],
      ),
      Question(
        ...
        options: [
          ...
          Option(
              ...
              comprehensionLevel: ComprehensionLevel.partial),
          Option(
              text: 'She wasn\'t scared of the cave.', comprehensionLevel: ComprehensionLevel.low),
        ],
      ),
      Question(
      ...
      Question(
        ...
        opservationCategory: OpservationCategory.emotionUnderstandingVisual,
        options: [
          Option(text: 'I think this is fear.', comprehensionLevel: ComprehensionLevel.high),
          Option(text: 'I think this is sadness ', comprehensionLevel: ComprehensionLevel.low),
          Option(text: 'I think this is anger', comprehensionLevel: ComprehensionLevel.low),
        ],
      ),
      Question(
        imageAssetPath: shuffledImages.getRandomNervousComplex(),
        ...
        opservationCategory: OpservationCategory.emotionUnderstandingVisual,
        options: [
          Option(text: 'Nervousness', comprehensionLevel: ComprehensionLevel.high),
